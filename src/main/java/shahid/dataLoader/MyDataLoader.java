...
public class MyDataLoader {
	...
	private void generateData() {
		...
		users.add(User.builder().name("Igor").createdAt(new Date()).age(24).articlesIds(new ArrayList<>()).friendsIds(new ArrayList<>()).build());
		users.add(User.builder().name("Ellen").createdAt(new Date()).age(24).articlesIds(new ArrayList<>()).friendsIds(new ArrayList<>()).build());
		users.add(User.builder().name("John").createdAt(new Date()).age(53).articlesIds(new ArrayList<>()).friendsIds(new ArrayList<>()).build());
		users.add(User.builder().name("Nazar").createdAt(new Date()).age(14).articlesIds(new ArrayList<>()).friendsIds(new ArrayList<>()).build());
		
		users = (ArrayList<User>) userRepository.save(users);
		...
		articles = (ArrayList<Article>) articleRepository.save(articles);
